  ...
  return (
    <>
      <Comp
        ...
        {...props}
      >
        <div className="absolute inset-0 -z-20 h-full w-full rounded-[inherit] shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_1px_2px_rgba(0,0,0,0.1)] transition-all pointer-events-none" />
        <div
          className="absolute inset-0 -z-10 h-full w-full rounded-[inherit] opacity-[0.04] mix-blend-overlay pointer-events-none"
          style={{
...
// GlassFilter is no longer needed since we are using TextureButton effect
...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-[#4A88E5] via-[#245AC6] to-[#143B8F]",
    button: "bg-gradient-to-b from-[#4F8BE7] to-[#1E4FAF]",
    textColor: "text-white",
